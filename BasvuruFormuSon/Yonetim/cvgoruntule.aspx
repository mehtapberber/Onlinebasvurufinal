<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cvgoruntule.aspx.cs" Inherits="BasvuruFormuSon.Yonetim.cvgoruntule" %>
...
<body style="background-color:#e3dfdf">
 ...
 <div class="container"  style="background-color:#FFFFFF; margin-left:auto; margin-bottom:20px; margin-right:auto;margin-top:20px;">
    ...
    <tr>
      ...
      <td> <div class="form-group">
          <asp:Label  ID="lblCinsiyet" Text="" CssClass="form-control" runat="server" />
          </div></td>
    </tr>
               <tr>
      <td> 
    ...
    <tr>
      ...
      <td> <div class="form-group">
          <asp:Label ID="lblAskerlikDurum" Text="" runat="server" CssClass="form-control" />
          </div></td>
    <td><div class="form-group">
      ...
      <td> <div class="form-group">
          <asp:Label Text="text" ID="lblMecburihizmet" runat="server" CssClass="form-control" />
          </div></td>
    <td><div class="form-group">
      ...
      <td> <div class="form-group">
          <asp:Label Text="" ID="lblSicil"  runat="server" CssClass="form-control" />
          </div></td>
    <td><div class="form-group">
    ...
    <tr>
      ...
      <td> <div class="form-group">
        ...
        <div style="text-align:center">
            ...
            <asp:Button ID="BtnYazdir" CssClass="btn btn-primary"  OnClientClick="javascript:window.print();" Text="Yazdır" runat="server" />
           </div>
